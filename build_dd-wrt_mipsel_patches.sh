...
export PATH="$HOME/dd-wrt_toolchains/toolchain-mipsel_74kc_gcc-8.2.0_musl/bin:$PATH"
...
ln -s $HOME/dd-wrt_toolchains/toolchain-mipsel_74kc_gcc-8.2.0_musl $DDWRT_REPO_DIR/toolchain
...
cp -vf $DDWRT_REPO_DIR/src/linux/universal/linux-4.4/.config_std $DDWRT_REPO_DIR/src/linux/universal/linux-4.4/.config
